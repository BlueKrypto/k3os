...
sudo apt-get remove -yq '^temurin-.*'
sudo apt-get remove -yq '^dotnet-.*'
sudo apt-get remove -yq '^llvm-.*'
sudo apt-get remove -yq 'php.*'
sudo apt-get remove -yq '^google-cloud-cli.*'
sudo apt-get remove -yq --ignore-missing \
    azure-cli \
    firefox \
